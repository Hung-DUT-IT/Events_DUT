        ...
        <div class="row">
                <div class="col-xl-4">
                    <div class="card-box">
                        ...
                        <div class="mt-4">
                            <span data-plugin="peity-bar" data-colors="#7266ba,#ebeff2" data-width="100%" data-height="36">5,3,9,6,5,9,7,3,5,2,9,7,2,1,3,5,2,9,7,2,5,3,9,6,5,9,7</span>
                        </div>
                    </div> <!-- end card-box-->
                </div> <!-- end col -->
                ...
                <div class="col-xl-4">
                    <div class="card-box">
                        ...
                        <div class="mt-4">
                            <span data-plugin="peity-line" data-fill="#f672a7" data-stroke="#f672a7" data-width="100%" data-height="36">3,5,2,9,7,2,5,3,9,6,5,9,7</span>
                        </div>
                    </div> <!-- end card-box-->
                </div> <!-- end col -->
